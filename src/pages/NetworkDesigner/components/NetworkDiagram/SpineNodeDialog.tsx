...
export default function SpineNodeDialog({
  connections,
  label,
  downlinks,
  network,
}: SpineNodeDialogProps) {
  ...
  // Create interfaces array for spine switch properties
  const interfaces = [];
                    ...
                    {connections && connections.length > 0 ? (
                      ...
                      <tr>
                        <td
                          ...
                          className="text-center text-xs text-muted-foreground p-4"
                        >
                          No connections found for this spine switch
                        </td>
                      </tr>
                    )}
                  </tbody>
